...
data "aws_iam_policy_document" "aggregated" {
  override_policy_documents = [
    ...
    # data.aws_iam_policy_document.user_password_ssm_permissions[0].json,
    # data.aws_iam_policy_document.user_password_kms_permissions[0].json,
    # data.aws_iam_policy_document.user_password_secretsmanager_permissions[0].json
  ]
}
